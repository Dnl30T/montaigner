<div class="box-lore">
    ...
    <div class="mail">
        ...
        <br>
        <p>
            Depois de passar pela Gota somos levados a sala do sacrifício, onde fazemos um pacto de sangue com Iekammandum, a entidade da justiça, jurando a nossa lealdade, a partir daí se trairmos os nossos irmãos, somos punidos... com a pior morte que o nosso cérebro conseguir imaginar, pra você ver o tamanho de nossa responsabilidade
        </p>
        <br>
        <p>
            Filha, eu queria ter a oportunidade de te contar mais, mas meu tempo aqui é curto, dá um abraço na sua mãe por mim e diz pra ela que eu a amo.
        <br><br>
        Te amo filha
        <br><br>
        -Papai
    ...
    <div class="infoAgent">
        <div class="info">
            <p>Agent: Daniel Davis</p>
            <p>Home country: Brazil</p>
            <p>age: 26 years</p>
            <p>Class: wizard</p>
            <p>Tier: A</p>
            <p>Status: Executed</p>
            <p>Corpse: not found</p>
            <p>Cause of death: Unknown</p>
            <p>Year of death: 2005</p>
        </div>
        <img src="<?php echo INCLUDE_PATH ?>images/Daniel.png" alt="">
    </div>
